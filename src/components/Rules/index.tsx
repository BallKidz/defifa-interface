      ...
      <div className={styles.phases}>
        <div className={styles.phaseBox}>
          ...
          <p>
            ...
            <br />
            <br />
            MINT TEAM NFTS TO INCREASE THE GAME’S TREASURY, HERE.
            <br />
            <br />
            THE NFT’S ARE A CLAIM ON THIS TREASURY. <br />
            <br />
            YOU CAN GET A FULL REFUND ANYTIME BEFORE THE GAME STARTS, HERE.
          </p>
        </div>
        <div className={styles.phaseBox}>
          <h1>PHASE 2: START</h1>
          <p>
            ...
            KICKOFF ON NOVERMBER 20, 2022.
            <br />
            <br />
            HOLDERS OF EACH TEAM’S NFTS WORK TOGETHER TO GUESS THE OUTCOME OF
            EACH WORLD CUP GAME THEIR TEAM PLAYS, ON DISCORD AND JOKEDAO.
            <br />
            <br />
        ...
        <div className={styles.phaseBox}>
          ...
          <p>
            ...
            <br />A FINAL SCORECARD IS UPLOADED ON-CHAIN HERE THAT SAYS HOW THE
            ...
            A SCORECARD HAS BEEN RATIFIED, HERE.
          </p>
        </div>
      </div>
      <br />
