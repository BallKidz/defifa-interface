      ...
      <div className="p-3 bottom-14 right-0 absolute">
        {isSelected ? (
          <div className="flex gap-2 items-center">
            <p>{selectedCount}</p>
            <button
              className="rounded-full disabled:cursor-not-allowed font-medium px-2 py-2 text-sm shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600 bg-violet-600 hover:bg-violet-500 text-neutral-50"
              onClick={onIncrement}
              disabled={
