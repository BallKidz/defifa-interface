...
>) => {
  return (
    <button
      {...props}
      className={twMerge(
        "min-w-[70px] transition-all rounded-lg font-medium px-3 py-2 text-sm shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600 inline-flex items-center",
        category === "primary"
          ? props.disabled
