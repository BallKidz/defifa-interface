...
//     {
//       fakeTokenId: "1000000001",
//       imageInfo: "QmSxpqaAdCFXoYCHvJzcEAFJJ7epqp86oUFTwZXcFxNbCa",
//     }, // BK logo
//   ]);

//   useEffect(() => {
//     fetchImagesForAllTiers(tiers, chainData, dataSource, provider).then(
//       (data) => {
//         setTierImages(data);
//       }
//     );
//   }, [chainData, dataSource, provider, tiers]);
...
//         return {
//           fakeTokenId: "1000000000",
//           imageInfo: "QmSxpqaAdCFXoYCHvJzcEAFJJ7epqp86oUFTwZXcFxNbCa",
//         }; //TODO: return default image 404
//       }
//     })
//   );
