// Import ABIs from deployment artifacts (official v5 Sepolia deployments)
import DefifaDelegate from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/sepolia/DefifaDelegate.json";
import DefifaDeployer from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/sepolia/DefifaDeployer.json";
import DefifaGovernor from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/sepolia/DefifaGovernor.json";
import DefifaTokenUriResolver from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/sepolia/DefifaTokenUriResolver.json";
