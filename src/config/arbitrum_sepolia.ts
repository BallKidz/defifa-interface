// Import ABIs from deployment artifacts (official v5 Arbitrum Sepolia deployments)
import DefifaDelegate from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/arbitrum_sepolia/DefifaDelegate.json";
import DefifaDeployer from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/arbitrum_sepolia/DefifaDeployer.json";
import DefifaGovernor from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/arbitrum_sepolia/DefifaGovernor.json";
import DefifaTokenUriResolver from "../../../defifa-collection-deployer-v5/deployments/defifa-v5/arbitrum_sepolia/DefifaTokenUriResolver.json";
